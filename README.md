...
- Чтобы можно было оценить работы и видеть, кто их оценивает

Это не заменяет настоящий GitHub — миниатюрная модель 1:10, так сказать.
...
Когда загружаются файлы в репозиторий, система делает **снимок** — полный список всех файлов на этот момент.  
Так проще и быстрее найти, что было в конкретном коммите.

Каждый файл хранится по-своему **SHA256-хешу** — словно отпечаток пальца контента.  
